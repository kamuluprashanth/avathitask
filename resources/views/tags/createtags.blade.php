   ...
   <div class="container">
        <div class="row">
            <div class="col-md-12 mx-auto mt-5">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">Add Tags <a href="{{url('showtags')}}" class="float-right text-white viewallusers">View All Tags</a></div>

                    <div class="card-body">
                        <!-- Display Validation Errors -->
                       

                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/storetags') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
